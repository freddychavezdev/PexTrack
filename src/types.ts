...
export interface WorkOrder { id: string; codigo_ot: string; cliente_nombre: string; cliente_telefono: string; direccion_referencial: string; tipo_tarea: string; estado: WorkOrderStatus; cuadrilla_id: string | null; cuadrilla_nombre?: string | null; fecha_programada: string; motivo_postergacion: string | null; lat: number; lng: number }
